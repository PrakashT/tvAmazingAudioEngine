...
#import <TheAmazingAudioEngine/Modules/TPCircularBuffer/TPCircularBuffer+AudioBufferList.h>
#import <Accelerate/Accelerate.h>

const int theBufferSize = 88200; /* Bytes per channel */
...
- (id)initWithNumberOfChannels:(int)numberOfChannels sampleRate:(Float32)sampleRate {
    ...
    TPCircularBufferInit(&_buffer, theBufferSize*numberOfChannels);
    self.hold = 22050;
    self.decay = 44100;
    self.attack = 2048;
    _level = 0.2;
